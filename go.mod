...
require (
	github.com/authzed/controller-idioms v0.9.1
...
// remove when https://github.com/kubernetes/kubernetes/pull/115887 is merged
replace k8s.io/client-go => github.com/ecordell/client-go v1.28.0-patchmeta
